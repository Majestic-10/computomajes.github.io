...
<body>
  ...
  <header class="container-fluid bg-danger d-flex justify-content-center">
    <p class="text-light mb-0 p-0 fs-6"> Gestión de adiministradores :V</p>
  </header>
  <!--fin de encavezado-->
        ...
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <a href="registrosS.php" class="nav-link align-middle px-0">
              ...
              <a href="registros.php" class="nav-link align-middle px-0">
                <svg class="bi me-2" width="40" height="32">
                  <use xlink:href="#lista" />
                </svg>
                <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline text-white">Registros de estudiantes</span>
              </a>  
            </li>
  ...
  <body>
    ...
    $consu = "SELECT*FROM admini";
    $resultado = mysqli_query($conexion, $consu);
    ?>
    <div class="container bg-white roundee p-4 col-xl-8 col-lg-8 mt-5">
    <h2 class="w-100 text-center mb-4">Gestión de Usuarios</h2>
        <a href="agregarU.php">Agregar Nuevo Usuario</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="editarU.php?id_admin=<?php echo $filas['id_admin'] ?>">
                            <button class="btn btn-warning btn-sm" type="button">Editar</button></div></a>
                            <a href="eliminarU.php?id_admin=<?php echo $filas['id_admin'] ?>">
